...
from .views import HomeView, PostDetailView, PostCreateView, PostUpdateView, CustomLoginView, CategoriaCreateView, PerfilAutorCreateView, ComentarioCreateView, ComentarioDeleteView, delete_post_direct
